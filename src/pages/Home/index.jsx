				...
				<div className={styles.card}>
					...
					<div className={styles.card__choice}>
						<ul className={styles.card__selector}>
							<li className={`${styles.choice__item} ${styles['choice__item-active']}`}>тонкое</li>
							<li className={styles.choice__item}>традиционное</li>
						</ul>
						<ul className={styles.card__selector}>
							<li className={`${styles.choice__item} ${styles['choice__item-active']}`}>26 см.</li>
					...
					<div className={styles.card__bottom}>
						...
						<button className={`${styles.card__button} ${styles['card__button-secondary']}`}>
							<svg
								width="12"
								height="12"
								viewBox="0 0 12 12"
